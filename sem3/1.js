/*Необходимо пользователя попросить ввести температуру в градусах Цельсия,
 ...
 в соответствующую температуру в градусах по Фаренгейту и вывести в alert
сообщение с текстом (пример):
...
*/
const celsius = prompt("Введите число: ");

function transfer(a) {
    return Math.floor(((9 / 5) * a + 32) * 100) / 100;
}
alert(`Цельсий: ${celsius}, Фаренгейт: ${transfer(celsius)}`); 